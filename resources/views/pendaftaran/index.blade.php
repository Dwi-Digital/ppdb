                            ...
                            <div class="row py-4">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="ex. 11*******5" autocomplete="off" maxlength="10" minlength="10" required>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="text" name="token" id="token" class="form-control @error('token') is-invalid @enderror"  value="{{ old('name') }}" placeholder="ex. 1AkuCpd" autocomplete="off" readonly required>
                                            ...
                                            <div class="col-lg-8">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="text" name="verifikator" id="verifikator" class="form-control @error('verifikator') is-invalid @enderror"  value="{{ old('verifikator') }}"
                                                        placeholder="Verifikator" autocomplete="off" readonly required>
                                ...
                                <div class="col-6">
                                    <div class="container">
                                        ...
                                        <div class="form-group mb-2">
                                            <label for="password" class="mb-2">Password <span class="text-danger">*</span>
                                            </label>

                                            <input type="password"
                                                class="form-control @error('password') is-invalid @enderror" name="password"
                                                placeholder="Password" id="passwordKu" autocomplete="new-password" required>
