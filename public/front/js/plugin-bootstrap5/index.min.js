...
! function (e, t) {
    ...
    return function (e) {
        function t(t) {
            var n = e.call(this, Object.assign({}, {
        ...
        return function (e, t) {
            ...
            if (("checkbox" === t || "radio" === t) && e.elements.length > 1 && o(e.element, "form-check-input")) {
                var n = e.element.parentElement;
                o(n, "form-check") && o(n, "form-check-inline") && i(n, {
                    "is-invalid": !e.valid,
                    "is-valid": e.valid
                })
            }
            ...
            o(t, "input-group") && (t.parentElement.insertBefore(e.iconElement, t.nextSibling), e.element.nextElementSibling && o(e.element.nextElementSibling, "input-group-text") && i(e.iconElement, {
                "fv-plugins-icon-input-group": !0
            }));
            var n = e.element.getAttribute("type");
            if ("checkbox" === n || "radio" === n) {
                var l = t.parentElement;
                o(t, "form-check") ? (i(e.iconElement, {
                    "fv-plugins-icon-check": !0
                }), t.parentElement.insertBefore(e.iconElement, t.nextSibling)) : o(t.parentElement, "form-check") && (i(e.iconElement, {
                    "fv-plugins-icon-check": !0
            ...
            var t = e.element.parentElement;
            if (o(t, "input-group")) return t.appendChild(e.messageElement), void i(t, {
                "has-validation": !0
            });
            var n = e.element.getAttribute("type");
            "checkbox" !== n && "radio" !== n || !o(e.element, "form-check-input") || !o(t, "form-check") || o(t, "form-check-inline") || e.elements[e.elements.length - 1].parentElement.appendChild(e.messageElement)
        }, t
    }(t.Framework)
}));
