...
<head>
    <meta charset="utf-8" />
    <meta name="viewport"
        content="width=device-width, initial-scale=1.0, user-scalable=yes, minimum-scale=1.0, maximum-scale=4.0" />
...
<body>
    ...
    <div data-bs-spy="scroll" class="scrollspy-example ">
            ...
            <div id="landingHome" class="section-py landing-hero position-relative">
                <div class="container">
                    <div class="hero-text-box text-center">
                        <h1 class="text-primary hero-title display-4 fw-bold" data-aos="zoom-in"
                            data-aos-duration="1000">P P D B <br>Dinas Pendidikan Aceh</h1>
                        <h2 class="hero-sub-title h6 mb-4 pb-1" data-aos="fade-up" data-aos-duration="1500">
                        ...
                        <div class="landing-hero-btn d-inline-block position-relative">
                            <span class="hero-btn-item position-absolute d-none d-md-flex text-heading"
                                data-aos="fade-right" data-aos-duration="2000">Daftar segera
                                <img src="{{ asset('storage/images/Join-community-arrow.png') }}"
                                    alt="Join community arrow" class="scaleX-n1-rtl" /></span>
                            <a href="/register" target="_blank" class="btn btn-primary" data-aos="fade-left"
                                data-aos-duration="2500">Ayo mulai daftar </a>
                        </div>
                    </div>
                        ...
                        <a href="/" target="_blank">
                            <div id="heroAnimationImg" class="position-relative hero-dashboard-img">
                                <img src="{{ asset('storage/images/PPDB.webp') }}" alt="hero dashboard"
                                    ...
                                    data-aos="zoom-in-up" data-aos-duration="3000" {{-- data-app-light-img="storage/images/pengumuman_ppdb.jpg')}}"
                                    data-app-dark-img="storage/images/pengumuman_ppdb.jpg')}}" --}} />
                                {{-- <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/front-pages/landing-page/hero-elements-light.png"
                                    alt="hero elements"
        ...
        <section id="landingZonasi" class="section-py landing-features">
            <div class="container">
                <div class="text-center mb-3 pb-1">
                    <span class="badge bg-label-primary" data-aos="fade-down" data-aos-duration="500">Zonasi
                        PPDB</span>
                </div>
                <h3 class="text-center mb-1" data-aos="fade-up" data-aos-duration="1500">
                    <span class="section-title">Pencarian wilayah zonasi sekolah</span>
                </h3>
                <p class="text-center mb-3 mb-md-5 pb-3" data-aos="fade-up" data-aos-duration="1000">
                    Sesuaikan dengan data <b>DAPODIK</b> atau <b>KK</b> Calon Peserta Didik.
                </p>
                <div class="features-icon-wrapper row gx-0 gy-4 g-sm-5">
                    <div class="col-lg-6 col-sm-6 text-center features-icon-box" data-aos="fade-right"
                    ...
                    <div class="col-lg-6 col-sm-6 text-center features-icon-box" data-aos="fade-left"
                ...
                <div class="dtzonasi" data-aos="fade-up" data-aos-duration="2000">
                ...
                @if (count($zonasi) > 0)
                    <div class="table-responsive mt-4" data-aos="fade-up" data-aos-duration="2500">
        ...
        <section id="landingAlur" class="section-py bg-body landing-reviews pb-0">
            ...
            <div class="container">
                <div class="row align-items-center gx-0 gy-4 g-lg-5">
                    <div class="col-md-6 col-lg-5 col-xl-3" data-aos="fade-right" data-aos-duration="2000">
                        <div class="mb-3 pb-1">
                    ...
                    <div class="col-md-6 col-lg-7 col-xl-9" data-aos="fade-left" data-aos-duration="2000">
        ...
        <section id="landingDokumen" class="section-py landing-team">
            <div class="container">
                <div class="text-center mb-3 pb-1">
                    <span class="badge bg-label-primary" data-aos="fade-up" data-aos-duration="1000">Dokumen
                        Pendukung</span>
                </div>
                <h3 class="text-center mb-1" data-aos="fade-up" data-aos-duration="1500"><span
                        class="section-title">Dokumen
                        Pendukung
                        Sekolah Juara Untuk Semua
                    </span></h3>
                <p class="text-center mb-md-5 pb-3" data-aos="fade-up" data-aos-duration="2000">Dokumen yang
                ...
                <div class="row gy-5 ">
                    ...
                    <div class="col-lg-6">
                        <div class="accordion mb-4" id="accordionExample" data-aos="fade-left"
        ...
        <section id="landingFunFacts" class="section-py landing-fun-facts">
            <div class="container">
                <div class="row gy-3 text-center">
                    <div class="text-center mb-3 pb-1">
                        <span class="badge bg-label-primary" data-aos="fade-up" data-aos-duration="1000">Total Kuota
                            Setiap Jalur</span>
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-3" data-aos="fade-down" data-aos-duration="2500">
                    ...
                    <div class="col-sm-6 col-lg-3" data-aos="fade-up" data-aos-duration="3000">
        ...
        <section id="landingFAQ" class="section-py bg-body landing-faq">
            <div class="container">
                <div class="text-center mb-3 pb-1">
                    <span class="badge bg-label-primary" data-aos="fade-up" data-aos-duration="1000">FAQ</span>
                </div>
                <h3 class="text-center mb-1" data-aos="fade-up" data-aos-duration="1500">Frequently asked <span
                        class="section-title">questions</span></h3>
                <p class="text-center mb-5 pb-3" data-aos="fade-up" data-aos-duration="2000">Beberapa pertanyaan yang
                    sering atau banyak ditanyakan.
                </p>
                <div class="row gy-5">
                    <div class="col-lg-5" data-aos="fade-left" data-aos-duration="2500">
                    ...
                    <div class="col-lg-7">
                        <div class="accordion" id="accordionExample">
                            <div class="card accordion-item active" data-aos="fade-right" data-aos-duration="1000">
                                <h2 class="accordion-header" id="headingOne">
                                    <button type="button" class="accordion-button" data-bs-toggle="collapse"
                                        data-bs-target="#accordionOne" aria-expanded="true"
                                        aria-controls="accordionOne">
                            ...
                            <div class="card accordion-item" data-aos="fade-right" data-aos-duration="1400">
                            ...
                            <div class="card accordion-item" data-aos="fade-right" data-aos-duration="2200">
                            ...
                            <div class="card accordion-item" data-aos="fade-right" data-aos-duration="2600">
                            ...
                            <div class="card accordion-item" data-aos="fade-right" data-aos-duration="3000">
            ...
            <div class="container">
                <div class="row align-items-center gy-5 gy-lg-0">
                    <div class="col-lg-6 text-center text-lg-start">
                        <h6 class="h2 text-primary fw-bold mb-1" data-aos="fade-up" data-aos-duration="1000">Tunggu
                            apa lagi?</h6>
                        <p class="fw-medium mb-4" data-aos="fade-up" data-aos-duration="1500">Ayo daftar sekarang
                            karena waktu terbtas.</p>
                        <a href="/access-pendaftaran" class="btn btn-primary" data-aos="fade-up"
                            data-aos-duration="2000">Daftar disini</a>
                    </div>
                    <div class="col-lg-6 pt-lg-5 text-center text-lg-end">
                        <img src="{{ asset('storage/images/reg.png') }}" width="200" alt="cta dashboard"
                            class="img-fluid" data-aos="fade-up" data-aos-duration="2000" />
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="landingPengaduan" class="section-py bg-body landing-contact">
            <div class="container">
                <div class="text-center mb-3 pb-1">
                    <span class="badge bg-label-primary" data-aos="zoom-in-up" data-aos-duration="1000">Helpdesk/Call
                        Center</span></span>
                </div>
                <h3 class="text-center mb-1" data-aos="zoom-in-up" data-aos-duration="1500"><span
                        class="section-title">Pusat Informasi</span></h3>
                <p class="text-center mb-4 mb-lg-5 pb-md-3" data-aos="zoom-in-up" data-aos-duration="2000">Hubungi
                    jika anda kendala atau pertanyaan seputar PPDB.</p>
                <div class="row gy-4">
                    <div class="col-lg-5">
                        <div class="contact-img-box position-relative border p-2 h-100" data-aos="zoom-in-up"
                            data-aos-duration="2500">
                    ...
                    <div class="col-lg-7">
                        <div class="card" data-aos="zoom-in-up" data-aos-duration="2500">
                            <div class="card-body">
                    ...
                    <div class="col-lg-5">
                        <a href="" class="app-brand-link mb-4">
                            <span class="app-brand-logo demo">
                                ...
                                <img src="{{ 'storage/images/PPDB12.png' }}" width="300" alt="">
    ...
    <div class="buy-now">
        <div class="btn-group ">
            <button type="button"
                ...
                data-bs-toggle="dropdown" aria-expanded="false"><img src="{{ asset('storage/images/wa.png') }}"
