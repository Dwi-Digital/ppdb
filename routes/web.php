...
Route::get('/', function (Request $request) {
    ...
    $total_daftar = Sekolah::withCount('cpd_zonasi')->get();
    $q = $request->input('q');
    $zonasi = [];
    ...
    PpdbView::updateOrCreate([
        'ip_address' => request()->ip(),
    ]);
    $view = PpdbView::latest()->paginate();

    return view('welcome',compact('kabupaten','zonasi','jalur','setPendaftaran','total_daftar','view'));
});
...
Route::post('forgot-password', [ForgotPasswordController::class, 'sendResetLinkEmail'])->name('password.email');
    ...
    Route::get('/app-access-profil', [App\Http\Controllers\UserController::class, 'profil'])->name('app-access-profil');
    ...
    Route::get('/getsekolah/{nm_kec}/{nm_desa}', [App\Http\Controllers\CarizonasiController::class, 'getSekolah'])->name('getsekolah');
    ...
    Route::group(['middleware' => ['auth', 'checkrole:cpd']], function () {
        ...
        Route::get('/app-down-cpd-pdf', [App\Http\Controllers\CpdController::class, 'cpdgeneratePDF'])->name('pdf.cpd');
    });
