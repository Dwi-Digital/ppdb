...
! function (e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t((e = "undefined" != typeof globalThis ? globalThis : e || self).FormValidation = {})
}(this, (function (e) {
    "use strict";
    var t, n = {
            exports: {}
    ...
    n.exports = function () {
        ...
        return i.Plugin = r, i.algorithms = e, i.formValidation = function (e, t) {
            var i = Object.assign({}, {
                    fields: {},
                    locale: "en_US",
                    plugins: {},
    ...
    var ce, ue = le.exports,
        fe = {
            exports: {}
        },
        pe = {};
    fe.exports = (ce || (ce = 1, pe.blank = function () {
        return {
            validate: function (e) {
                return {
                    valid: !0
        ...
        return _e.date = function () {
            return {
                validate: function (e) {
                    ...
                    var v = o.separator || (-1 !== p.indexOf("/") ? "/" : -1 !== p.indexOf("-") ? "-" : -1 !== p.indexOf(".") ? "." : "/");
                    ...
                    if (c) {
                        ...
                        var C = O.length > 0 ? O[0].length <= 2 && /^\d+$/.test(O[0]) ? parseInt(O[0], 10) : -1 : 0,
                            I = O.length > 1 ? O[1].length <= 2 && /^\d+$/.test(O[1]) ? parseInt(O[1], 10) : -1 : 0,
                            _ = O.length > 2 ? O[2].length <= 2 && /^\d+$/.test(O[2]) ? parseInt(O[2], 10) : -1 : 0;
                        if (-1 === C || -1 === I || -1 === _) return l;
                        if (_ < 0 || _ > 60) return l;
                        if (C < 0 || C >= 24 || u && C > 12) return l;
                        if (I < 0 || I > 59) return l;
                        F.setHours(m && "PM" === m.toUpperCase() && C < 12 ? C + 12 : C), F.setMinutes(I), F.setSeconds(_)
                    }
                    ...
                    switch (!0) {
                        case !!j && !N:
                            return {
                                message: t(e.l10n ? e.l10n.date.min : s, j), meta: {
                                    date: F
                                }, valid: F.getTime() >= S.getTime()
                            };
                        case !!N && !j:
                            return {
                                message: t(e.l10n ? e.l10n.date.max : s, N), meta: {
                                    date: F
                                }, valid: F.getTime() <= P.getTime()
                            };
                        case !!N && !!j:
                            return {
                                message: t(e.l10n ? e.l10n.date.range : s, [j, N]), meta: {
                                    date: F
                                }, valid: F.getTime() <= P.getTime() && F.getTime() >= S.getTime()
                            };
                        default:
                            return {
                                message: "".concat(s), meta: {
                                    date: F
                                }, valid: !0
                            }
                    }
    ...
    var He, Se = Ie.exports,
        ke = {
            exports: {}
        },
        Pe = {};
    ke.exports = (He || (He = 1, Pe.different = function () {
        return {
            validate: function (e) {
    ...
    var je, Ne = ke.exports,
        Le = {
            exports: {}
        },
        Te = {};
    Le.exports = (je || (je = 1, Te.digits = function () {
        return {
            validate: function (e) {
                return {
    ...
    Re.exports = function () {
        ...
        return ze.emailAddress = function () {
            return {
                validate: function (i) {
                    if ("" === i.value) return {
                        valid: !0
    ...
    $e.exports = function () {
        ...
        var e = o,
            t = e.utils.format,
            n = e.utils.removeUndefined;
        return Xe.greaterThan = function () {
            return {
                validate: function (e) {
                    if ("" === e.value) return {
                        valid: !0
    ...
    var Je, Ke = $e.exports,
        ...
        Qe = {};
    We.exports = (Je || (Je = 1, Qe.identical = function () {
        return {
            validate: function (e) {
                var t = "function" == typeof e.options.compare ? e.options.compare.call(this) : e.options.compare;
                return {
            ...
            return {
                validate: function (t) {
                    ...
                    switch (!0) {
                        case n.ipv4 && !n.ipv6:
                            return {
                                message: t.l10n ? n.message || t.l10n.ip.ipv4 : n.message, valid: i.test(t.value)
                            };
                        case !n.ipv4 && n.ipv6:
                            return {
                                message: t.l10n ? n.message || t.l10n.ip.ipv6 : n.message, valid: r.test(t.value)
                            };
                        case n.ipv4 && n.ipv6:
                        default:
                            return {
                                message: t.l10n ? n.message || t.l10n.ip.default : n.message, valid: i.test(t.value) || r.test(t.value)
                            }
                    }
                }
            }
    ...
    var ft, pt = ct.exports,
        ht = {
            exports: {}
        },
        mt = {};
    ht.exports = (ft || (ft = 1, mt.notEmpty = function () {
        return {
            validate: function (e) {
    ...
    var wt, Ft = Vt.exports,
        Ot = {
            exports: {}
        },
        Ct = {};
    Ot.exports = (wt || (wt = 1, Ct.regexp = function () {
        return {
            validate: function (e) {
                if ("" === e.value) return {
                    valid: !0
    ...
    Mt.exports = function () {
        ...
        var e = o,
            t = e.utils.format,
            n = e.utils.removeUndefined;
        return Dt.stringLength = function () {
            return {
                validate: function (e) {
                    var i = Object.assign({}, {
                            message: "",
    ...
    e.Plugin = o.Plugin, e.algorithms = o.algorithms, e.formValidation = function (e, t) {
        var n = o.formValidation(e, t);
        return Object.keys(Gt).forEach((function (e) {
            return n.registerValidator(e, Gt[e])
        })), n
    }, e.plugins = qt, e.utils = o.utils, e.validators = Gt
}));
