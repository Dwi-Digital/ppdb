    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header">
                <h5><i class="ti-folder"></i> AKUN SEKOLAH </h5>
                <hr>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <form action="/store-user" class="row g-3" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-12">
                            ...
                            <select name="instansi" id="instansisekolah" class="form-control @error('instansi') is-invalid @enderror" required>
                                <option value="">--pilih--</option>
                                @foreach ($getsekolah as $p)
                                    <option value="{{ $p->satpen }}">{{ $p->satpen }}</option>
                                @endforeach
                            </select>
