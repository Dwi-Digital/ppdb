...
$(function () {
        ...
        e.length && e.DataTable({
            ...
            columnDefs: [{
                ...
                orderable: !1,
                render: function (e, a, t, s) {
                    return '<a href="' + c + '" class="btn btn-sm btn-icon"><i class="bx bx-show-alt"></i></a>'
                }
            }],
            order: [
                [1, "desc"]
